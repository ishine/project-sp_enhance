...
omlsa_float32_t Su[FRAME_LEN21];			//B
omlsa_float32_t S_u[FRAME_LEN21];			//B
omlsa_float32_t St_u[FRAME_LEN21];			//B
omlsa_float32_t Smin_u[FRAME_LEN21];			//B
omlsa_float32_t Smact_u[FRAME_LEN21];			//B
omlsa_float32_t Smint_u[FRAME_LEN21];			//B
omlsa_float32_t Smactt_u[FRAME_LEN21];		//B
omlsa_float32_t S_his0_u[FRAME_LEN21][8];		//8*B
omlsa_float32_t S_his_u[FRAME_LEN21][8];		//8*B 
...
omlsa_float32_t eta_2term_y[FRAME_LEN21];		//B    21k
omlsa_float32_t eta_2term_u[FRAME_LEN21];		//B    21k
omlsa_float32_t q_hat[FRAME_LEN21];
omlsa_float32_t xi[FRAME_LEN21];			//B    38k
omlsa_float32_t PSI[FRAME_LEN21] ;
omlsa_float32_t lambda_d_hat[FRAME_LEN21], alpha_d_hat[FRAME_LEN21];
omlsa_float32_t lambda_dav_u[FRAME_LEN21];	//B
omlsa_float32_t lambda_d_u[FRAME_LEN21];    //B   
double LAMDBA_0 = 1.54; 
